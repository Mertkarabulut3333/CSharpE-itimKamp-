...
namespace _01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine();
            //int totalPrice = totalHamburgerPrice + totalCokePrice + totalFriesPrice + totalLemonadePrice + totalPizzaPrice + totalWaterPrice;
